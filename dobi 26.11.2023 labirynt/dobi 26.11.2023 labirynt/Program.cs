...
class Program
{
    static void Main()
    {
        ...
        while (true)
        {
            ...
            Console.WriteLine("3. zapisz labirynt w pliku txt");
            Console.WriteLine("4. wczytaj labirynt z pliku txt");
            Console.WriteLine("5. zapisz labirynt w konosli");
            Console.WriteLine("6. wczytaj labirynt z konsoli");
            ...
            switch (wybor)
            {
                ...
                case "2":
                    ...
                    break;
                case "3":
                    bool zapis3 = labirynt.GetLength(0) == 0;
                    if (zapis3 == false)
                    {
                ...
                case "4":
                    try
                    {
                        ...
                        string nazwaPlikuWczyt = Console.ReadLine();
                        using (StreamReader reader = new StreamReader(nazwaPlikuWczyt + ".txt"))
                        {
                            string linia;
                    ...
                    {
                        Console.WriteLine("BŁĄD! podano bledna nazwe pliku do wczytania");
                    }
                    break;
                case "5":
